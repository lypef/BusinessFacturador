...
$datos['receptor']['Domicilio']['localidad'] = 'CIUDAD DE MEXICO';
...
//    $datos['factura']['IdContabilidad']='123456';//opcional
    ...
    $datos['parcialesconstruccion']['NumPerLicoAut']='12345678901234567890';
    $datos['parcialesconstruccion']['Inmueble']['Calle']='Juarez';
    $datos['parcialesconstruccion']['Inmueble']['NoExterior']='1025';
    $datos['parcialesconstruccion']['Inmueble']['NoInterior']='5';
    $datos['parcialesconstruccion']['Inmueble']['Colonia']='Centro';
    $datos['parcialesconstruccion']['Inmueble']['Localidad']='Torreon';
    $datos['parcialesconstruccion']['Inmueble']['Referencia']='Entre Hidalgo y Morelos';
    $datos['parcialesconstruccion']['Inmueble']['Municipio']='Torreon';
    $datos['parcialesconstruccion']['Inmueble']['Estado']='09';
    $datos['parcialesconstruccion']['Inmueble']['CodigoPostal']='27054';
