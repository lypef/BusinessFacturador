...
$datos['cfdi']='timbrados/cfdi_ejemplo_factura_erronea.xml'; // NO SE GENERARA
// OPCIONAL GUARDAR EL XML GENERADO ANTES DE TIMBRARLO
$datos['xml_debug']='timbrados/sin_timbrar_ejemplo_factura_erronea.xml';
...
//    $concepto['descripcion'] = "PRODUCTO PRUEBA > '$i'";
    ...
    $concepto['importe'] = '';                                                  //<--- ERROR SIMULADO
...
$translado1['impuesto'] = 'I.V.A.';                                                  //<--- ERROR SIMULADO
$translado1['tasa'] = '16';
