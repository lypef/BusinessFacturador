...
// ACTIVA COMPATIBILIDAD PARA HOSTING RESTRINGIDOS
// LA GENERACION DE LOS CERTIFICADOS .PEM LA GENERARA
// NUESTRO WEBSERVICE
// TU CERTIFICADO, LLAVE Y CONTRASEÑA SERAN ENVIADAS A NUESTRO EQUIPO
// Y ELIMINADAS EN MAXIMO 10 SEGUNDOS.
// ESTE PROCESO SOLO SE EJECUTA AL INGRESAR UN NUEVO CERTIFICADO 
...
$datos['cfdi']='timbrados/cfdi_ejemplo_factura_hosting_restringido.xml';
// OPCIONAL GUARDAR EL XML GENERADO ANTES DE TIMBRARLO
$datos['xml_debug']='timbrados/sin_timbrar_cfdi_ejemplo_factura_hosting_restringido.xml';
...
$res= cfdi_retenicion_generar_xml($datos);
