...
$datos['cfdi']='timbrados/cfdi_ejemplo_factura_ine.xml';
// OPCIONAL GUARDAR EL XML GENERADO ANTES DE TIMBRARLO
$datos['xml_debug']='timbrados/sin_timbrar_ejemplo_factura_ine.xml';
...
//    $datos['factura']['IdContabilidad']='123456';//opcional
    ...
    $datos['ine'][0]['Entidad']['ClaveEntidad']='DIF';
    $datos['ine'][0]['Entidad']['Ambito']='Local';
//    $datos['ine'][0]['Entidad']['TipoComite']='Ejecutivo Estatal';     //opcional
//    $datos['ine'][0]['Entidad']['IdContabilidad']='123456'; //(opcional)
    $datos['ine'][0]['Entidad']['contabilidad'][0]['IdContabilidad']='123456';
    $datos['ine'][0]['Entidad']['contabilidad'][1]['IdContabilidad']='246810';
    $datos['ine'][0]['Entidad']['contabilidad'][2]['IdContabilidad']='473657';
    
    $datos['ine'][1]['Entidad']['ClaveEntidad']='QTO';
    $datos['ine'][1]['Entidad']['Ambito']='Federal';
//    $datos['ine'][1]['Entidad']['TipoComite']='Ejecutivo Estatal';     //opcional
//    $datos['ine'][1]['Entidad']['IdContabilidad']='636485'; //(opcional)
    $datos['ine'][1]['Entidad']['contabilidad'][0]['IdContabilidad']='636485';
    $datos['ine'][1]['Entidad']['contabilidad'][1]['IdContabilidad']='377697';
